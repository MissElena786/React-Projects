...
function Icecreame() {
   ...
   const URL = `https://api.edamam.com/api/recipes/v2?type=public&q=icecream&app_id=${import.meta.env.REACT_APP_API_ID}&app_key=${import.meta.env.REACT_APP_API_KEY}`
  ...
  return (
   <div className='pizza min-h-screen p-20 bg-gray-100'>
   <h1 className='text-6xl mb-10 text-center font-extrabold text-yellow-500'>Icecream</h1>
