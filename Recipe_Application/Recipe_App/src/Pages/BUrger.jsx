...
function BUrger() {
   ...
   const URL = `https://api.edamam.com/api/recipes/v2?type=public&q=burger&app_id=${import.meta.env.REACT_APP_API_ID}&app_key=${import.meta.env.REACT_APP_API_KEY}`
  ...
  return (
   ...
   <h1 className='text-6xl mb-10 text-center font-extrabold text-yellow-500'>Burger</h1>
